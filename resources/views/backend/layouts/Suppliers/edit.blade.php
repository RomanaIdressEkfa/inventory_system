    ...
    <html lang="en">
        ...
        <body>
            ...
            <div class="container border border-light shadow mt-2 rounded p-4">
                <h3 class=" text-primary mb-4 text-center" style='font-weight:bold'>EDIT SUPPLIER</h3>
                ...
                @endif
                <form action="{{ route("supplier_details_update", $supplier->id) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="name" class="form-label">Name</label>
                                <input type="text" value="{{ $supplier->name }}" class="form-control" id="name" name="name" placeholder="Enter your name">
                                @if ($errors->has("name"))
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email" value="{{ $supplier->email }}" class="form-control" id="email" name="email" placeholder="name@example.com">
                                @if ($errors->has("email"))
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="tel" value="{{ $supplier->phone_number }}" class="form-control" id="phone_number" name="phone_number" placeholder="Enter your phone number">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="payment_terms" class="form-control" id="payment_terms"  value="{{ $supplier->payment_terms }}" name="payment_terms" placeholder="Enter your Payment Terms">
