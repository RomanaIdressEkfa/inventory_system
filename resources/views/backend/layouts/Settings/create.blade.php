    ...
    <html lang="en">
        ...
        <body>
            ...
            <div class="container border border-light shadow p-4 rounded">
                <h3 class=" text-primary mb-4 text-center" style='font-weight:bold'>ADD SETTINGS</h3>
                <form action="{{ route("settings_details_store") }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="value" name="value" placeholder="Enter your value">
                                @if ($errors->has("value"))
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="data_type" name="data_type" placeholder="Enter your data_type">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="default_value" name="default_value" placeholder="Enter your default_value">
